...
class AutoFitPreviewBuilder private constructor(
    ...
    private fun updateTransform(
        ...
        previewWidth = bufferRotatedWidth
        previewHeight = bufferRotatedHeight

        println("bufferRotatedWidth $bufferRotatedWidth")
        println("bufferRotatedHeight $bufferRotatedHeight")
    ...
    companion object {
        ...
        var xScaleValue: Float = 0.0f
        var yScaleValue: Float = 0.0f
