...
//    }
    ...
    public static void copyExif(String sourcePath, String destPath) {
        try {
            android.media.ExifInterface source = new android.media.ExifInterface(sourcePath);
            android.media.ExifInterface dest = new android.media.ExifInterface(destPath);
